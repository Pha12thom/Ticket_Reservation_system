...
<html>
  ...
  <body>
	...
	<div class="ui grid">
            <div class="row">
         <h1 class="ui huge header">All Traveling Classes</h1>
         </div>
        <div class="ui horizontal divider"> Travel Classes Available</div>      
		<div class="row">
            <table class="ui single line striped selectable center aligned  table">
<thead><tr><th>#Class_ID</th><th>Travel Class</th><th>Class Capacity</th><th>Class Price</th><th>Description/Offer</th></tr></thead>
<tbody>
<?php
